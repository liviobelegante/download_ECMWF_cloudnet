...
Library and CLI tool to read ECMWF profiles from Cloudnet and cache them locally.
Version 0.11.0 – Livio Belegante, INOE

See `profiles.py` for details or run:
    cloudnet-profiles --help
